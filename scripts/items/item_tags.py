    ...
    with open(file_path, 'w', encoding='utf-8') as file:
        ...
        if write_type == "templates":
            ...
            page_content = (
                ...
                "==Usage==\n"
                "Help out the PZwiki by adding where and how this tag is used. <span class=\"plainlinks\">[{{fullurl:{{FULLPAGENAMEE}}|veaction=edit}} Edit] ([{{fullurl:Special:CreateAccount|returnto={{FULLPAGENAMEE}}}} create account])</span>\n\n"
                "==List of items=="
                f"\n{item_content}\n\n"
                "==See also==\n"
