...
def main():
    ...
    table_helper.create_tables("security", items, table_map=table_map, columns=column_headings, suppress=True, bot_flag_type="security_item_list", combine_tables=False)
