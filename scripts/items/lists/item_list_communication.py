...
def main():
    ...
    table_helper.create_tables("communication_item_list", items, table_map=table_map, columns=column_headings, suppress=True, bot_flag_type="communication_item_list", combine_tables=False)
