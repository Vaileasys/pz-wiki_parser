...
def main():
    ...
    table_helper.create_tables("corpse_item_list", items, table_map=table_map, columns=column_headings, suppress=True, bot_flag_type="corpse_item_list", combine_tables=False)
