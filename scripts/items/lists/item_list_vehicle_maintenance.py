...
def main():
    ...
    table_helper.create_tables("vehicle_maintenance_item_list", items, table_map=table_map, columns=column_headings, suppress=True, bot_flag_type="vehicle_maintenance_item_list", combine_tables=False)
