...
def main():
    ...
    table_helper.create_tables("light_source", items, table_map=table_map, columns=column_headings, suppress=True, bot_flag_type="light_source_item_list", combine_tables=False)
