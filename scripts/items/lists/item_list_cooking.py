...
def main():
    ...
    table_helper.create_tables("cooking", items, table_map=table_map, columns=column_headings, suppress=True, bot_flag_type="cooking_item_list", combine_tables=False)
