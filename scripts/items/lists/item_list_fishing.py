...
def main():
    ...
    table_helper.create_tables("fishing_item_list", items, table_map=table_map, columns=column_headings, suppress=True, bot_flag_type="fishing_item_list", combine_tables=False)
