...
def main():
    ...
    table_helper.create_tables("fire_source", items, table_map=table_map, columns=column_headings, suppress=True, bot_flag_type="fire_source_item_list", combine_tables=False)
