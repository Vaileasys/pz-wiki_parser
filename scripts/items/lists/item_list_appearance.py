...
def main():
    ...
    table_helper.create_tables("appearance", items, table_map=table_map, columns=column_headings, suppress=True, bot_flag_type="appearance_item_list", combine_tables=False)
