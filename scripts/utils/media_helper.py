...
CODES = {
    ...
    "BLA": {"id": "blacksmith", "title": "IGUI_perks_Blacksmith", "icon": "File:Anvil_Forged.png", "type": "skill", "scale": 12.5},
    "GLA": {"id": "glassmaking", "title": "IGUI_perks_Glassmaking", "icon": "File:GlassBottle.png", "type": "skill", "scale": 12.5},
    "HUS": {"id": "husbandry", "title": "IGUI_perks_Husbandry", "icon": "File:CowBlack_Calf.png", "type": "skill", "scale": 12.5},
    "BUT": {"id": "butchering", "title": "IGUI_perks_Butchering", "icon": "File:MeatCleaver.png", "type": "skill", "scale": 12.5},
    "TRK": {"id": "tracking", "title": "IGUI_perks_Tracking", "icon": "File:Dung_Deer.png", "type": "skill", "scale": 12.5},
