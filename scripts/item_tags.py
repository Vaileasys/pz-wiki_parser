...
def write_article(tag, item_content, see_also_list, dest_dir):
    ...
    with open(file_path, 'w', encoding='utf-8') as file:
        ...
        if write_type == "templates":
            page_content = (
                f"<noinclude>\n{{{{Documentation|doc=\n"
                f"{{{{Autogenerated|reason=Any changes to this page will be overwritten automatically ''(Last updated: {version.get_version()})''.|source=[https://github.com/Vaileasys/pz-wiki_parser pz-wiki_parser (GitHub)]|hidecat=true}}}}\n"
            ...
            page_content = (
                ...
                f"{{{{Page version|{version.get_version()}}}}}\n{{{{Autogenerated|tags}}}}\n"
