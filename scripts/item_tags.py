...
MENU_STRUCTURE_ROOT = {
    ...
    "1": {"name": "Article content", "description": "Generate tag content to be used on articles.", "function": "article_content"},
    "2": {"name": "Template articles", "description": "Generate tag template articles", "function": "generate_article_templates"},
    "3": {"name": "Modding articles", "description": "Generate tag modding articles", "function": "generate_article_modding"}
}
...
MENU_STRUCTURE_CONTENT = {
    ...
    "2": {"name": "Tag item list", "description": "Outputs a separate table for each tag with a list of items that have it.", "function": "write_tag_list"},
    "3": {"name": "Tag table", "description": "Outputs all tags in a single table with a list of items that have it.", "function": "write_tag_table"}
}
