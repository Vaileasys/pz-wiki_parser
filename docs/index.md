...
- [consumables.py](scripts/consumables.md)
- [distribution.py](scripts/distribution.md)
- [fixing.py](scripts/fixing.md)
...
- [translate.py](scripts/core/translate.md)
...
- [clothing_list.py](scripts/lists/clothing_list.md)
- [container_list.py](scripts/lists/container_list.md)
- [fluid_container_list.py](scripts/lists/fluid_container_list.md)
- [fluid_list.py](scripts/lists/fluid_list.md)
- [food_list.py](scripts/lists/food_list.md)
- [fuel_list.py](scripts/lists/fuel_list.md)
...
- [item_list.py](scripts/lists/item_list.md)
- [literature_list.py](scripts/lists/literature_list.md)
- [recmedia_list.py](scripts/lists/recmedia_list.md)
- [weapon_list.py](scripts/lists/weapon_list.md)
...
- [fixing_parser.py](scripts/parser/fixing_parser.md)
...
- [legacy_recipe_format.py](scripts/recipes/legacy_recipe_format.md)
- [legacy_recipe_output.py](scripts/recipes/legacy_recipe_output.md)
- [legacy_recipe_parser.py](scripts/recipes/legacy_recipe_parser.md)
...
- [compare_item_lists.py](scripts/tools/compare_item_lists.md)
- [item_dict.py](scripts/tools/item_dict.md)
