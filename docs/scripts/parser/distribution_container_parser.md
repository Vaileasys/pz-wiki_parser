[Previous Folder](../objects/animal.md) | [Previous File](creation_method_parser.md) | [Next File](distribution_parser.md) | [Next Folder](../recipes/craft_recipes.md) | [Back to Index](../../index.md)
...
### [`sort_keys(data, is_top_level = False)`](https://github.com/Vaileasys/pz-wiki_parser/blob/main/scripts/parser/distribution_container_parser.py#L49)
