[Previous Folder](../items/lists/item_list_animal_part.md) | [Previous File](outfit_list.md) | [Next Folder](../misc/item_merger.md) | [Back to Index](../../index.md)

# recmedia_list.py

## Functions

### [`generate_data(guid: str, rm_data: dict)`](https://github.com/Vaileasys/pz-wiki_parser/blob/main/scripts/lists/recmedia_list.py#L14)
