[Previous Folder](../navbox/navbox.md) | [Previous File](evolved_recipe.md) | [Next File](fish.md) | [Next Folder](../parser/creation_method_parser.md) | [Back to Index](../../index.md)
...
##### [`from_item(item: Item | str) -> 'Farming | None'`](https://github.com/Vaileasys/pz-wiki_parser/blob/main/scripts/objects/farming.py#L64)

##### [`from_recipe(recipe: str | list[str]) -> 'Farming | None'`](https://github.com/Vaileasys/pz-wiki_parser/blob/main/scripts/objects/farming.py#L79)

#### Object Methods

##### [`__init__(crop: str)`](https://github.com/Vaileasys/pz-wiki_parser/blob/main/scripts/objects/farming.py#L89)

##### [`get_sprite(sprite = None, dim = '32x32px') -> str`](https://github.com/Vaileasys/pz-wiki_parser/blob/main/scripts/objects/farming.py#L93)
