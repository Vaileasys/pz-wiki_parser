[Previous Folder](../navbox/navbox.md) | [Previous File](skill.md) | [Next File](vehicle.md) | [Next Folder](../parser/creation_method_parser.md) | [Back to Index](../../index.md)
...
##### [`from_item(item: Item) -> 'Item | Trap'`](https://github.com/Vaileasys/pz-wiki_parser/blob/main/scripts/objects/trap.py#L42)
...
##### [`get_sprite(sprite = None, dim = '32x32px')`](https://github.com/Vaileasys/pz-wiki_parser/blob/main/scripts/objects/trap.py#L53)
...
##### [`all() -> dict[str, 'TrapAnimal']`](https://github.com/Vaileasys/pz-wiki_parser/blob/main/scripts/objects/trap.py#L142)
