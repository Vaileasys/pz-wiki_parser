[Previous Folder](../navbox/navbox.md) | [Previous File](body_location.md) | [Next File](components.md) | [Next Folder](../parser/creation_method_parser.md) | [Back to Index](../../index.md)
...
<ins>**Args:**</ins>
  - **decal_name (str)**:
      - _The name of the decal (XML filename without extension)._
...
<ins>**Args:**</ins>
  - **clothing_item (str)**:
      - _The item ID to load (e.g., 'Tshirt_SpiffoDECAL')._
...
<ins>**Args:**</ins>
  - **decals (list[ClothingDecal])**:
      - _A list of ClothingDecal objects._
